...
{
    static Dictionary<string, byte[]> files = null;
    ...
    private static void Main(string[] args)
    {
        ...
        files = GetWebFiles(filename, Path.GetFileNameWithoutExtension(filename));

        HttpServer http = new HttpServer(listen_port);
    ...
    private static void Http_OnGet(object? sender, HttpRequestEventArgs e)
    {
